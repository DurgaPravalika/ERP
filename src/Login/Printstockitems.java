...
public class Printstockitems {
	...
	public static void main(String[] args) 
	{
        ...
        driver.findElement(By.xpath("//*[@class='ewExportLink ewPrint']")).click();

        WebElement printtable=driver.findElement(By.xpath("//*[@class='table-bi']"));
